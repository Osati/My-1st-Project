        ...
        <form action="insert.php" method="POST" algin="center" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="container-col"> 
              ...
              <b><label id="from"><img class="icon" src="icon/password.png"/>Your Password:</label></br>
                <input type="password" name="password" id="from" placeholder="Inter Your Password" required></br></br>
              <b><label id="from"><img class="icon" src="icon/show-password.png"/>Confirm Password:</label></br>

...
<head>
  ...
  <link rel="stylesheet" href="phpall.css">
...
<body>
  <div id="container">
    ...
    <b><label id="from"><img class="icon" src="icon/class.png"/>Class Name:</label><b></br>
    <input type="text" name="class" id="from" placeholder="Inter Your Admission class name" required></br></br>
    <b><label id="from"><img class="icon" src="icon/roll.png"/> Class Roll:</label><b></br>
    ...
    <button name="student" type="submit" id="button" value="Submt">submit</button>
